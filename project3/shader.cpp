...
Shader* ShaderGlobals::currShader;
...
Shader::Shader()
{
	...
	this->seeThrough_handle = BAD_GL_VALUE;

	this->Material_ADSS_handle = BAD_GL_VALUE;
	this->l1_pos_handle = BAD_GL_VALUE;
	this->l2_pos_handle = BAD_GL_VALUE;
	this->l3_pos_handle = BAD_GL_VALUE;
	this->on1_handle = BAD_GL_VALUE;
	this->on2_handle = BAD_GL_VALUE;
...
void Shader::CommonSetup(const float time, const GLint * size, const GLfloat * projection, const GLfloat * modelview, const GLfloat * mvp, const GLfloat * nm)
{
	...
	glUniform3fv(light_position_handle, 1, glm::value_ptr(light1.lightPosEyeCoords));
	glUniform1i(this->seeThrough_handle, this->seeThrough);

	glUniform1f(this->l3_percent_handle, l3Intensity);

	glUniform4fv(this->Material_ADSS_handle, 1, glm::value_ptr(this->Material_ADSS));
	glUniform3fv(this->l1_pos_handle, 1, glm::value_ptr(light1.lightPosEyeCoords));
	glUniform3fv(this->l2_pos_handle, 1, glm::value_ptr(light2.lightPosEyeCoords));
	glUniform3fv(this->l3_pos_handle, 1, glm::value_ptr(light3.lightPosEyeCoords));
...
bool Shader::Initialize(char * vertex_shader_file, char * fragment_shader_file)
{
	...
	this->light_position_handle = glGetUniformLocation(this->program_id, (const GLchar *) "light_position_in");
	this->seeThrough_handle = glGetUniformLocation(this->program_id, (const GLchar *) "seeThrough_in");

	this->Material_ADSS_handle = glGetUniformLocation(this->program_id, (const GLchar *) "Material_ADSS");
	this->l1_pos_handle = glGetUniformLocation(this->program_id, (const GLchar *) "light_position_1_in");
	this->l2_pos_handle = glGetUniformLocation(this->program_id, (const GLchar *) "light_position_2_in");
	this->l3_pos_handle = glGetUniformLocation(this->program_id, (const GLchar *) "light_position_3_in");
	this->on1_handle = glGetUniformLocation(this->program_id, (const GLchar *) "on_1_in");
