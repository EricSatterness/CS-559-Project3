...
//
//
//bool RecordingImage::GetScreen(WindowData *wndData)
//{
//	//each line is an additional 0 to 4 bytes longer than necessairy because the pixels are word alligned by row
//	int rasterWidth = wndData->fullWidth.pixel + ((wndData->fullWidth.pixel % 4 == 0) ? 0 : (4 - (wndData->fullWidth.pixel % 4)));
//	unsigned long lImageSize = rasterWidth * 3 * wndData->fullHeight.pixel;
//
//	GLbyte	*pBits = NULL; 
...
//	glReadPixels(0, 0, wndData->fullWidth.pixel, wndData->fullHeight.pixel, GL_BGR_EXT, GL_UNSIGNED_BYTE, pBits);
//
...
//		return false;
//}
//ImageWriter::ImageWriter(WindowData *wndData)
//{
...
//	int newWidth = wndData->viewPortWidth.pixel;
//	int height = wndData->viewPortHeight.pixel; 
//
...
//}
//bool ImageWriter::_init(string videoPath, int framesPerSecond, bool requireDeleteExistingVideo)
//{
//	//this->videoName = videoPath;
//	//Commeting out this section means videos will automatically
//	//be overwritten
//	if(requireDeleteExistingVideo && FileExists(videoPath))
//	{
//		return false;
//	}
//	avi = CreateAvi(videoPath.c_str(),framesPerSecond,NULL);
//	recordImage = new RecordingImage(wndData->viewPortWidth.pixel, wndData->viewPortHeight.pixel);
//	firstRecordedImage = true;
//	fps = framesPerSecond;
//	return true;
//}
//bool ImageWriter::InitRecording(string videoPath, int framesPerSecond, bool requireDeleteExistingVideo)
//{
//	recording = _init(videoPath, framesPerSecond, requireDeleteExistingVideo);
//	return recording;
//}
//void ImageWriter::RequestRecord()
//{
//	recordRequested = true;
//}
//bool ImageWriter::RecordIfRequested()
//{
//	bool ret = false;
//	if(!recording)
//		recordRequested = false;
//	if(recordRequested)
//		ret = this->RecordImage();
//	recordRequested = false;
//	return ret;
//}
//
...
//{
//	bool success = recordImage->GetScreen(wndData);
