...
void Top::Draw(const mat4 & projection, mat4 modelview, const ivec2 & size)
{
	...
	if (this->draw_normals)
	{
		...
		this->solid_color.CommonSetup(0.0f, value_ptr(size), value_ptr(projection), value_ptr(modelview), value_ptr(mvp), value_ptr(nm));
